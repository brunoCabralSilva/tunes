...
class Usuario extends React.Component {
  ...
  render() {
    ...
    return (
      <div className="flex flex-row rounded-full justify-center p-1 items-center text-sm sm:text-base bg-half-light ml-2 mr-2 mt-0 mb-2 sm:m-2 text-dark" data-testid="header-user-name">
